...
if (count($res) > 0) {
    $res = $pdo->prepare("INSERT INTO purchased SET user_id = :user_id, products_id = :products_id, category = :category, qtde = :qtde, date_purchased = :date_purchased, time_purchased = :time_purchased, payment = :payment");
    ...
    $res->bindValue(':time_purchased', Date('H:m'), PDO::PARAM_STR);
